...
<div class="container py-3">
    <div class="card-header">Company name: {{$company->fname}}</div>
    <div class="card-header">Company name: {{$company->lname}}</div>
    <div class="card-header">Company name: {{$company->company_name}}</div>
    <div class="card-header">Company name: {{$company->email}}</div>
    <div><br></div>
    <h2 class="my-3">Open post for this company</h2>
